...
- Runtime Call Stack Document: `tickets/in-progress/browser-mcp-transport-modes/future-state-runtime-call-stack.md`
- Source Design Basis:
  - `Small`: `tickets/in-progress/browser-mcp-transport-modes/implementation-plan.md` (solution sketch)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Design-ready | v1-draft | v1 | No | No | N/A | N/A | N/A | 1 | Candidate Go | No-Go |
| 2 | Design-ready | v1-draft | v1 | No | No | N/A | N/A | N/A | 2 | Go Confirmed | Go |
