...
from autobyteus_browser.json_codec import dumps_strict, loads_strict
from autobyteus_browser.policy import ArtifactPolicy
    ...
    async def resolve_page(self, tab_id: str) -> FakePage:
        for page in self.context.pages:
            if page.target_id == tab_id and not page.is_closed():
                return page
        from autobyteus_browser.errors import tab_not_found
